    ...
    xhttp.onreadystatechange = function(){
        if(this.readyState==4 && this.status == 200){
            ...
            for(let object of objects){
               ...
               trHTML += '<td><button type="button" class="btn btn-outline-warning" onclick="showProductEditBox('+ object['id'] +')"> Edit </button> <button type="button" class="btn btn-outline-danger" onclick="productDelete('+ object['id'] +')"> Delete </td>';
               trHTML +='</tr>';
            }
...
function showProductEditBox(id){
    ...
    xhttp.onreadystatechange = function(){
        if(this.readyState==4 && this.status == 200){
            ...
            Swal.fire({
               title: 'Edit Product',
               html : 'ID : <input id="id" type="text" disabled class="swal2-input" value='+ objects[0].id +'>' + '<br>Product Name : <input id="product_name" type="text" class="swal2-input" value='+ objects[0].product_name +'>'+ '<br>Product Price : <input id="product_price" type="text" class="swal2-input" value='+ objects[0].product_price +'>'+ '<br>Product Cost: <input id="product_cost" type="text" class="swal2-input" value='+ objects[0].product_cost +'>'+ '<br>Image: <input id="product_image" type="text" class="swal2-input" value='+ objects[0].product_image +'>',
               focusConfirm : false,
               preConfirm: () =>{
                ProductEdit();
               }
